...
To acquire the motor parameters, calculations had to be made, since there did not exist any datasheet to the DC motor in use. The parameters needed was the internal resistance and the motor constant, k_{\phi}.
