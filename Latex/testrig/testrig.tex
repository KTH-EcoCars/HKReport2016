...
\end{equation}
TODO: FEL, ska nog vara $F_r$ istället för $F_{tr}$
...
\begin{equation} \label{eq:testrig_totaldynamics} 
    T_m = F_{tr} r_r + J_{tot} \dot{\omega}_m + d_{tot} \omega_m + \mu_{tot},
\end{equation}

TODO: FEL i ekvationen, möjligt korrekt:
\begin{equation} \label{eq:testrig_totaldynamics2} 
    T_m = \frac{F_{tr} r_w + J_{tot} \dot{\omega}_m + d_{tot} \omega_m + \mu_{tot}}{n_1 n_2},
\end{equation}

TODO: Alternativt:
\begin{equation} \label{eq:testrig_totaldynamics3} 
