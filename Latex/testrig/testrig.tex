...
that controls what track to input to the motor driver. If the voltage exceeds 47 volt
the microcontroller will activate a relay between the power resistors and ground,
and it will remain closed until the supercap has discharged to 45 volt where
...
of a dynamic system is known, a parameterisized model based on the real
