...
%%TODO, lägga in blockschema över logiken till bräningsstyrning+?? Ska lägga in wiring diagram för förbränning iaf.

\begin{figure}[H]
    \centering
    \label{fig:bildeen}
    \includegraphics[width=\textwidth]{./img/bildeen}
    \caption{schematics}
\end{figure}
