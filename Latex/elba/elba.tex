...
%TODO: Picture of communication between components
...
micro-controllers. Any data that is needed elsewhere is sent on the CAN-bus. Each CAN message consists of CAN id, a 32 bit upper data integer and a 32 bit lower data integer. Messages sent from Front ECU are sent with id 170, from Back ECU 169, and from ICE ECU 114. Data position in the messages on the CAN-bus can be seen in table REF, counting the lowest bit as bit 1.

\noindent{}\begin{tabular}{|r|c|l|}
%TODO: complete and fix layout
\textbf{data} & \textbf{id} & \textbf{bits}\\
Reference Speed & 170 & 1-16 \\
Brake & 170 & 17 \\
Reference Mode & 170 & 20-23 \\
Auto & 170 & 24 \\
Current Mode & id & bits \\
\end{tabular}
