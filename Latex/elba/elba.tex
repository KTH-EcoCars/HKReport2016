...
uploaded to the arduino directly from simulink. Simulink->Arduino also gives the
option for running ``external mode'' a Hardware in the loop type compile mode.
